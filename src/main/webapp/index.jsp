...
<script type="text/javascript">
	var socket =new WebSocket("wss://172.25.99.1:8443/ssmws/games");
	var isCaller = window.location.href.split('#')[1];
	//var isCaller = window.location.href;
...
<body>
	...
	<a id="create" href="/ssmws/index.jsp#true" onclick="init()">点击此链接新建聊天室</a><br>
